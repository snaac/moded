...
from bot import bot, Interval, INDEX_URL, VIEW_LINK, aria2, QB_SEED, dispatcher, DOWNLOAD_DIR, \
                download_dict, download_dict_lock, TG_SPLIT_SIZE, LOGGER, MEGA_KEY, DB_URI, INCOMPLETE_TASK_NOTIFIER, botname, LOG_CHAT, LOG_CHAT_URL
...
class MirrorListener:
    ...
    def onUploadComplete(self, link: str, size, files, folders, typ, name: str):
        ...
        if self.isLeech:
            ...
            if LOG_CHAT:
                fmsg.copy(LOG_CHAT)
                pmsg += f'\nI Have Sent Files in <a href="{LOG_CHAT_URL}">Logs Channel</a>'
            ...
            if LOG_CHAT:
                ...
                pmsg += f'\nI Have Sent Links in <a href="{LOG_CHAT_URL}">Logs Channel</a>'
            sendMessage(msg + pmsg, self.bot, self.message)
